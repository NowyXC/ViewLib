package com.nowy.viewlib.views.smartrefresh.layout;
...
import com.nowy.viewlib.views.smartrefresh.layout.api.DefaultRefreshFooterCreater;
import com.nowy.viewlib.views.smartrefresh.layout.api.DefaultRefreshHeaderCreater;
import com.nowy.viewlib.views.smartrefresh.layout.api.RefreshContent;
import com.nowy.viewlib.views.smartrefresh.layout.api.RefreshFooter;
import com.nowy.viewlib.views.smartrefresh.layout.api.RefreshHeader;
import com.nowy.viewlib.views.smartrefresh.layout.api.RefreshKernel;
import com.nowy.viewlib.views.smartrefresh.layout.api.RefreshLayout;
import com.nowy.viewlib.views.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.nowy.viewlib.views.smartrefresh.layout.constant.DimensionStatus;
import com.nowy.viewlib.views.smartrefresh.layout.constant.RefreshState;
import com.nowy.viewlib.views.smartrefresh.layout.constant.SpinnerStyle;
import com.nowy.viewlib.views.smartrefresh.layout.footer.BallPulseFooter;
import com.nowy.viewlib.views.smartrefresh.layout.header.BezierRadarHeader;
import com.nowy.viewlib.views.smartrefresh.layout.impl.RefreshContentWrapper;
import com.nowy.viewlib.views.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.nowy.viewlib.views.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.nowy.viewlib.views.smartrefresh.layout.listener.OnLoadmoreListener;
import com.nowy.viewlib.views.smartrefresh.layout.listener.OnMultiPurposeListener;
import com.nowy.viewlib.views.smartrefresh.layout.listener.OnRefreshListener;
import com.nowy.viewlib.views.smartrefresh.layout.listener.OnRefreshLoadmoreListener;
import com.nowy.viewlib.views.smartrefresh.layout.util.DelayedRunable;
import com.nowy.viewlib.views.smartrefresh.layout.util.DensityUtil;
import com.nowy.viewlib.views.smartrefresh.layout.util.ViscousFluidInterpolator;
...
//        }
    ...
    public SmartRefreshLayout setFooterHeight(float heightDp) {
        return setFooterHeightPx(AppUtil.dip2px(getContext(),heightDp));
    }
    ...
    public SmartRefreshLayout setHeaderHeight(float heightDp) {
        return setHeaderHeightPx(AppUtil.dip2px(getContext(),heightDp));
    }
