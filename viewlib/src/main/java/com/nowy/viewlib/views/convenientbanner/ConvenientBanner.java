package com.nowy.viewlib.views.convenientbanner;
...
import com.nowy.viewlib.views.convenientbanner.adapter.CBPageAdapter;
import com.nowy.viewlib.views.convenientbanner.holder.CBViewHolderCreator;
import com.nowy.viewlib.views.convenientbanner.listener.CBPageChangeListener;
import com.nowy.viewlib.views.convenientbanner.listener.OnItemClickListener;
import com.nowy.viewlib.views.convenientbanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public void setPageTurningPointView(ViewGroup view){
        if(view != null){
            loPageTurningPoint = view;
        }
    }
     ...
     * @return
     */
    public ConvenientBanner setPointViewVisible(int visible) {
    ...
    public ConvenientBanner setPageIndicatorAlign(PageIndicatorAlign align) {
        if(loPageTurningPoint.getLayoutParams() instanceof RelativeLayout.LayoutParams){
