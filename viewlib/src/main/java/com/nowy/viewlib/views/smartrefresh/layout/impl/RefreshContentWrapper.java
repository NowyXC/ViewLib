package com.nowy.viewlib.views.smartrefresh.layout.impl;
...
import com.nowy.viewlib.views.smartrefresh.layout.util.ScrollBoundaryUtil;
    ...
    protected View findScrollableViewByEvent(View content, MotionEvent event, View orgScrollableView) {
        if (content instanceof ViewGroup && event != null) {
            ...
            for (int i = childCount; i > 0; i--) {
                ...
                if (ScrollBoundaryUtil
                        .isTransformedTouchPointInView(viewGroup, child, event.getX(), event.getY(), point)) {
