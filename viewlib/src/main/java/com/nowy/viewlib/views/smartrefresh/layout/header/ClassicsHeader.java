package com.nowy.viewlib.views.smartrefresh.layout.header;
...
import com.nowy.viewlib.views.smartrefresh.layout.internal.ProgressDrawable;
import com.nowy.viewlib.views.smartrefresh.layout.internal.pathview.PathsDrawable;
...
//    public static String REFRESH_HEADER_LASTTIME = "'Last update' M-d HH:mm";
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        LinearLayout.LayoutParams lpHeaderText = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        layout.addView(mTitleText, lpHeaderText);
        LinearLayout.LayoutParams lpUpdateText = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        layout.addView(mLastUpdateText, lpUpdateText);

        LayoutParams lpHeaderLayout = new LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
