package com.nowy.viewlib.views.gridview;
...
//					int numColumns = attrs.getInt(R.styleable.GridView_numColumns, 1);
//					attrs.getInt
					mOriginalCol = attrs.getAttributeIntValue(i,1);
					updateColumns(mOriginalCol);
					break;
				}
			}
		}
	 ...
	 */
	private void updateColumns(int col) {
		this.numColumns = col;
	}
